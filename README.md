...
- [`math/rh_weil/README.md`](math/rh_weil/README.md) — RH / Weil finite-compression verifier — finite-dimensional certificates; no RH proof. It studies polynomial compressions of the localized Weil quadratic form on one cell, and is a research program alongside the benchmarks below, not the mission of this repository.
