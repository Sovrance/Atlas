...
work_order: original notebook -> Atlas integration (pre ENG-004)
---

> **HISTORICAL — do not act on this document.**
>
> This is the original integration work order, preserved because WO-RH-17 forbids deleting
> contrary evidence and because the reasoning that produced the current state is itself
> evidence. Two of its instructions are now false: it says WO-RH-05 is open (ENG-005
> recovered it as a cutoff-free uniform E1) and that degree 3 must not start until WO-RH-05
> closes (ENG-006 implemented degree 3 and certified the odd block at inertia `(2,0,0)`).
>
